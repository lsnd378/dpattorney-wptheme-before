<?php
/**
 * The template for displaying practice area archive pages
 *
...
$practice_areas = dpattorney_get_practice_areas(-1);
?>
        ...
        <div class="container">
            <div class="practice-header">
                <div class="reveal">
                    ...
                    <h1 class="practice-title"><?php _e('Area Praktik', 'dpattorney'); ?></h1>
                </div>
                <p class="practice-description reveal" style="transition-delay: 0.2s;">
