<?php
/**
 * The template for displaying team member archive pages
 *
...
// Get current team type from URL
$current_type = get_query_var('team_type') ?: 'partner';
...
// Get team members
$team_members = dpattorney_get_team_members($current_type, -1);
?>
    ...
    <section class="team-section" style="padding-top: 3rem;">
        <div class="container">
            <div class="team-header reveal">
                ...
                <h1 class="team-title"><?php _e('Kenali Tim Kami', 'dpattorney'); ?></h1>
